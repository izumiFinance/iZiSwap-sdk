...
describe("test swapX2Y", ()=>{
    ...
    //     const {amountX, amountY} = SwapX2YModule.swapX2YDesireY(pool, totalAcquireY, lowPoint)
    ...
    // test('test swapX2YDesireY liquidity and limit order, start with liquidityX=0, end with partial limit order', () => {
    //     const liquidityData = [
    ...
    // test('test swapX2YDesireY liquidity and limit order, start with liquidityX=liquidity, end with full limit order', () => {
    //     const liquidityData = [
    //         getDataPair(-5000, 200000),
    //         // 2000
    //         getDataPair(3600, 0),
    ...
    // test('test swapX2YDesireY liquidity, start with zero liquidityX, end with full liquidity', () => {
    //     const liquidityData = [
    ...
    // test('test swapX2YDesireY liquidity, start with liquidityX partial, end with lowPt', () => {
    //     const liquidityData = [
    //         getDataPair(-80, 200000),
    //         getDataPair(80, 600000),
    //         getDataPair(3600, 0),
    ...
    //     const {amountX, amountY} = SwapX2YModule.swapX2YDesireY(pool, veryBigNumber, lowPoint)
    ...
    // test('test swapX2YDesireY liquidity, start with liquidityX partial, end with lowPt=currentPoint', () => {
    //     const liquidityData = [
    //         getDataPair(-80, 200000),
    //         getDataPair(80, 600000),
    //         getDataPair(3600, 0),
    ...
    // test('test swapX2YDesireY liquidity, start with liquidityX partial, end with lowPt=currentPoint-1', () => {
    //     const liquidityData = [
    //         getDataPair(-80, 200000),
    //         getDataPair(80, 600000),
    //         getDataPair(3600, 0),
    ...
    // test('test swapX2YDesireY liquidity, start with liquidityX partial, end with lowPt=liqudityPoint[0]', () => {
    //     const liquidityData = [
    //         getDataPair(80, 600000),
    //         getDataPair(3600, 0),
    //     ]
    ...
    // test('test swapX2YDesireY liquidity, start with liquidityX partial, end with lowPt=sellingYPoint[0]', () => {
    //     const liquidityData = [
    //         getDataPair(80, 600000),
    //         getDataPair(3600, 0),
    //     ]
    ...
    test('test swapX2YDesireY liquidity, start with liquidityX partial, currentPoint is liquidityPoint, end with full liquidity', () => {
        const liquidityData = [
            getDataPair(80, 600000),
        ...
        const acquireYInRange = [
            JSBI.add(
                calc.l2Y(JSBI.BigInt('600000'), LogPowMath.getSqrtPrice(88), false),
                calc.yInRange('600000', 89, 2000, 1.0001, false)
            ),
        ...
        const costXInRange = [
            JSBI.add(
                calc.l2X(JSBI.BigInt('600000'), LogPowMath.getSqrtPrice(88), true),
                calc.xInRange('600000', 89, 2000, 1.0001, true)
            ),
    ...
    test('test swapX2YDesireY liquidity, start with liquidityX=0, currentPoint is liquidityPoint, end with full liquidity', () => {
        const liquidityData = [
            getDataPair(80, 600000),
            getDataPair(2000, 800000),
            getDataPair(3600, 0),
    ...
    test('test swapX2YDesireY liquidity, start with liquidityX=liquidity, currentPoint is liquidityPoint, end with partial liquidity', () => {
        const liquidityData = [
            getDataPair(80, 600000),
            getDataPair(2000, 800000),
            getDataPair(3600, 0),
        ...
        const acquireYInRange = [
            JSBI.add(
                calc.l2Y(JSBI.BigInt('500000'), LogPowMath.getSqrtPrice(88), false),
                calc.yInRange('600000', 89, 2000, 1.0001, false)
            )
        ]
        ...
        const costXInRange = [
            JSBI.add(
                calc.l2X(JSBI.BigInt('500000'), LogPowMath.getSqrtPrice(88), true),
                calc.xInRange('600000', 89, 2000, 1.0001, true)
            )
        ]
