...
describe("test swapY2XDesire", ()=>{
    test('test swapY2XDesire liquidity and limit order', () => {
        const liquidityData = [
        ...
        const {amountX, amountY} = SwapY2XModule.swapY2XDesireX(pool, totalAcquireX, highPoint)
    ...
    test('test swapY2XDesireX liquidity and limit order, end with partial limit order', () => {
        const liquidityData = [
            getDataPair(1000, 200000),
            // 2400
            getDataPair(3600, 0),
        ...
        const totalAcquireX = calc.getSum(acquireX)
        const totalDesireX = calc.getSum(desireX)
        const totalCostY = calc.amountListAddFee(costY, JSBI.BigInt(2000))
        ...
        const {amountX, amountY} = SwapY2XModule.swapY2XDesireX(pool, totalDesireX, highPoint)
    ...
    test('test swapY2XDesireX liquidity and limit order, start with zero liquidityX, end with full limit order', () => {
        const liquidityData = [
            getDataPair(1000, 200000),
            // 2400
            getDataPair(3600, 0),
    ...
    test('test swapY2XDesireX liquidity, start with zero liquidityX, end with full liquidity', () => {
        const liquidityData = [
            getDataPair(1000, 200000),
    ...
    test('test swapY2XDesireX liquidity, end with highPt', () => {
        const liquidityData = [
            getDataPair(1000, 200000),
            getDataPair(3600, 0),
        ]
        ...
        const {amountX, amountY} = SwapY2XModule.swapY2XDesireX(pool, veryBigNumber, highPoint)
    ...
    test('test swapY2XDesireX liquidity and limit order, highPt = currentPt + 1', () => {
        const liquidityData = [
            getDataPair(1000, 200000),
            getDataPair(3600, 0),
        ]
