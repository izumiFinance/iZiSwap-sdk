...
import { getSwapExactInputCall, getUniversalQuoterContract, getUniversalSwapRouterContract, quoteExactInput } from '../../src/universalRouter'
import { SwapExactInputParams } from '../../src/universalRouter/types';
...
async function main(): Promise<void> {
    ...
    // const inputAmountDecimal = 0.1
    // const inputAmount = new BigNumber(inputAmountDecimal).times(10 ** WBNB.decimal).toFixed(0)
    ...
    // const outputAmountDecimal = amount2Decimal(new BigNumber(outputAmount), WBNB)
